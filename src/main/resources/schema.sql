...
CREATE TABLE IF NOT EXISTS film_genres (
	...
	CONSTRAINT film_genres_fk_1 FOREIGN KEY (genre_id) REFERENCES genres(genre_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS film_directors (
	...
	CONSTRAINT film_directors_fk FOREIGN KEY (film_id) REFERENCES films(film_id) ON DELETE CASCADE,
	CONSTRAINT film_directors_fk_1 FOREIGN KEY (director_id) REFERENCES directors(director_id) ON DELETE CASCADE
);
...
(
    ...
    user_id BIGINT NOT NULL,
    film_id BIGINT NOT NULL,
    CONSTRAINT reviews_fk FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE,
    CONSTRAINT reviews_fk_1 FOREIGN KEY (film_id) REFERENCES films(film_id) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT reviews_likes_fk FOREIGN KEY (review_id) REFERENCES reviews_likes(review_id) ON DELETE CASCADE,
